...
export default function EditIntentionScreen({ route }) {
  ...
  return (
    <View className="flex-1 bg-[#3c324a] p-5">
      ...
      <Text className="text-pink-200 italic mb-4">After coming home from work in the evening</Text>
      ...
      <View className="flex-row items-center mb-4">
        ...
        <TextInput value={startTime} onChangeText={setStartTime} className="bg-white px-3 py-1 rounded-md w-20" />
        <Text className="text-white mx-2">and</Text>
        <TextInput value={endTime} onChangeText={setEndTime} className="bg-white px-3 py-1 rounded-md w-20" />
        <Switch value={timeReminderEnabled} onValueChange={setTimeReminderEnabled} className="ml-2" />
      </View>

      <View className="flex-row items-center mb-6">
        <Text className="text-white mr-2">Within</Text>
        <TextInput value={distance} onChangeText={setDistance} className="bg-white px-3 py-1 rounded-md w-16" />
        <Text className="text-white mx-2">ft of</Text>
        <TextInput value={location} onChangeText={setLocation} className="bg-white px-3 py-1 rounded-md w-24" />
        <Switch value={locationReminderEnabled} onValueChange={setLocationReminderEnabled} className="ml-2" />
      </View>

      {/* Save Button */}
      <TouchableOpacity onPress={handleSave} className="bg-white rounded-2xl py-3 items-center">
